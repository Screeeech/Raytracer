...
struct Matrix final
{
    ...
    Matrix(const Vector3& xAxis, const Vector3& yAxis, const Vector3& zAxis, const Vector3& t);
    ...
    [[nodiscard]] Vector4 TransformPoint(float x, float y, float z, float w) const;
